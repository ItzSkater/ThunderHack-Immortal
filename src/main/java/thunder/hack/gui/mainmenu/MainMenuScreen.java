...
public class MainMenuScreen extends Screen {
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        //  FontRenderers.sf_medium.drawString(context.getMatrices(), "By ItzSkater & 06ED", halfOfWidth * 2 - FontRenderers.sf_medium.getStringWidth("By ItzSkater & 06ED") - 5f, halfOfHeight * 2 - 10, Render2DEngine.applyOpacity(-1, 0.4f));
