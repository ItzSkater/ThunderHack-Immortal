...
public class ConfigManager implements IManager {
    ...
    public void loadCloud(String name) {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new URL("https://raw.githubusercontent.com/ItzSkater/ThunderHack-Immortal/main/configs/" + name + ".th").openStream());
    ...
    public List<String> getCloudConfigs() {
        List<String> list = new ArrayList<>();
        try {
            URL url = new URL("https://raw.githubusercontent.com/ItzSkater/ThunderHack-Immortal/main/cloudConfigs.txt");
