...
public final class ThunderUtility {
    ...
    public static void parseStarGazer() {
        ...
        try {
            for (int page = 1; page <= 3; page++) {
                URL url = new URL("https://api.github.com/repos/ItzSkater/ThunderHack-Immortal/stargazers?per_page=100&page=" + page);
    ...
    public static void syncContributors() {
        try {
            URL list = new URL("https://raw.githubusercontent.com/ItzSkater/ThunderHack-Immortal/main/team.txt");
