...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "immortal", getPosX() + 35.5f, getPosY() + 21f, 1);
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), "Immortal", getPosX() + 18, getPosY() + 5, 20);
