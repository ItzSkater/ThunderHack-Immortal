...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.thglitch.drawString(context.getMatrices(), "RACE", getPosX() + 5.5, getPosY() + 5, -1);
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "client", getPosX() + 35.5f, getPosY() + 21f, 1);
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), "Race Client", getPosX() + 18, getPosY() + 5, 20);
